...
export default function NetworkingDBContent() {
  return (
    <main className="pb-20">
      <div className="mb-6">
        <Link href="/#networking-db-hub" className="text-accent font-medium inline-flex items-center gap-2 hover:underline group">
      ...
      <ScrollAnimation>
        <header className="portfolio-header">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">Networking & DB Internals</h1>
          <p className="text-lg text-text-secondary max-w-3xl">
            Deep dive into network protocols, load balancing, database engines, indexing, and distributed transactions.
          </p>
        </header>
      </ScrollAnimation>
