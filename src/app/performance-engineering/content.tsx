...
export default function PerformanceEngineeringContent() {
  return (
    <main className="pb-20">
      <div className="mb-6">
        <Link href="/#perf-eng" className="text-accent font-medium inline-flex items-center gap-2 hover:underline group">
      ...
      <ScrollAnimation>
        <header className="portfolio-header">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">Performance Engineering</h1>
          <p className="text-lg text-text-secondary max-w-3xl">
            Master the art of high-performance systems: from kernel-level profiling and memory optimization to global-scale latency analysis and capacity planning.
          </p>
        </header>
      </ScrollAnimation>
