    ...
    <main className="pb-20">
      ...
      <ScrollAnimation>
        <header className="portfolio-header">
          <h1>Frontend Performance Deep Dive</h1>
          <p>Master the technical depth of high-performance web applications: from Core Web Vitals and resource delivery to rendering optimization and advanced hydration patterns.</p>
        </header>
      </ScrollAnimation>
